    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <div class="row">
                <div class="col-lg-10">
                    <?= form_open_multipart('product/edit/' . $prod['id']); ?>
                    <div class="form-group row">
                        <label for="item" class="col-sm-2 col-form-label">Item Name</label>
                        <div class="col-sm-6">
                            <input type="text" class="form-control" name="item" id="item" value="<?= $prod['item_name']; ?>">
                        </div>
                        <div class="col-sm-4">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <input type="number" class="form-control" name="purchase_price" id="purchase_price" value="<?= $prod['purchase_price']; ?>">
                        </div>
                        <div class="col-sm-4">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <input type="number" class="form-control" name="selling_price" id="selling_price" value="<?= $prod['selling_price']; ?>">
                        </div>
                        <div class="col-sm-4">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <div class="row">
                                <div class="col-sm-2">
                                    <img src="<?= base_url('uploads/product/') . $prod['image']; ?>" class="img-thumbnail">
                                </div>
                                <div class="col-lg-5">
